...
_EN = {
    ...
    "note_counts": "Counts show cached pictures. Updated dates use the latest Drive date for the folder or its pictures (UTC).",
    "note_order": "Photos play newest first by their creation date in Google Drive. Month buckets use that date in UTC.",
...
_ZH = {
    ...
    "note_counts": "数量表示已缓存的照片。更新日期采用文件夹或其中照片在云端硬盘中的最新日期（UTC）。",
    "note_order": "照片按在 Google 云端硬盘中的创建日期从新到旧播放。月份分组使用该日期的 UTC 时间。",
...
_ZH_MESSAGES = {
    ...
    "The local checkout is ahead of release/2.x; automatic update is disabled.": "本地代码领先于 release/2.x；自动更新已禁用。",
    "The local checkout has diverged from release/2.x; automatic update is disabled.": "本地代码与 release/2.x 已分叉；自动更新已禁用。",
    "Wi-Fi setup is not enabled on this device.": "此设备未启用 Wi-Fi 设置。",
    "Checking the board connection. Cached playback continues.": "正在检查设备连接。缓存的照片会继续播放。",
    "Wi-Fi helper unavailable. Cached playback continues.": "Wi-Fi 辅助服务不可用。缓存的照片会继续播放。",
    "Internet unavailable — cached slideshow continues.": "互联网不可用——缓存的幻灯片会继续播放。",
    "Starting the setup hotspot. Cached playback continues.": "正在启动设置热点。缓存的照片会继续播放。",
    ...
    "Already connected. Wi-Fi setup becomes available when internet is lost.": "已连接。互联网断开时会启用 Wi-Fi 设置。",
